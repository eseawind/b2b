...
public class AutoLoginAction extends BaseAction
{
  public ActionForward executeAction(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
  {
    ...
    ArrayList localArrayList3 = localBuffers3.BuffersToBuffer(localBuffers3);
    if (localBuffers3.getInt("RESULT_CODE") != 0)
    {
      paramHttpServletRequest.setAttribute("outBuffer", localBuffers3);
      paramHttpServletRequest.setAttribute("backQ", localArrayList3);
    ...
    int i = 0;
    if (localBuffers2.getString("COOKIETIME") != null)
      i = Integer.parseInt(localBuffers2.getString("COOKIETIME"));
    ArrayList localArrayList4 = new ArrayList();
    localArrayList4 = localBuffers2.getSessionList();
    Iterator localObject1 = localArrayList4.iterator();
    while (( localObject1).hasNext())
    {
      HashMap localObject2 = (HashMap)(localObject1).next();
    ...
    Object localObject4 = localBuffers2.getString("SUCCEED_FWD");
