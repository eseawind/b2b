...
public class StoreformOutInfo
{
  ...
  public HashMap getOneStoreFormOut(String paramString1, String paramString2)
    throws SaasApplicationException
  {
    ArrayList localArrayList = new ArrayList();
    ...
    try
    {
      localStoreformOutExt.setParam(":VCUST_ID", paramString1);
      localStoreformOutExt.setParam(":VQUO_ID", paramString2);
      localArrayList = localStoreformOutExt.selByList("SEL_ONE_STORE_FORM");
    }
    catch (RuntimeException localRuntimeException)
    {
      this.log.LOG_INFO(localRuntimeException.getMessage());
 ...
 * Qualified Name:     com.saas.biz.storeformOutMgr.StoreformOutInfo
