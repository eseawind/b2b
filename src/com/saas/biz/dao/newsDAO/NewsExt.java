...
public class NewsExt extends NewsDAO
{
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_news");
  ...
  public NewsDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    Field[] arrayOfField = localNewsDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localNewsDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localNewsDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_news");
  ...
  public NewsDAO getFromBuffer(Buffers paramBuffers)
  {
    Dbexecute localDbexecute = new Dbexecute();
    String str = "com.saas.biz.dao.newsDAO.NewsDAO";
    NewsDAO localNewsDAO = (NewsDAO)localDbexecute.getFromBuffer(str, paramBuffers);
    return localNewsDAO;
  }
 ...
 * Qualified Name:     com.saas.biz.dao.newsDAO.NewsExt
