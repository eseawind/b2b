package com.saas.biz.dao.shoppingorderDAO;
...
public class ShoppingOrderExt extends ShoppingOrderDAO
{
  private static final long serialVersionUID = 3435438429265830862L;
  ShoppingOrderDAO shoporderDao = new ShoppingOrderDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_shopping_order");
  ...
  public ShoppingOrderDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    Field[] arrayOfField = localShoppingOrderDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localShoppingOrderDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localShoppingOrderDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_shopping_order");
 ...
 * Qualified Name:     com.saas.biz.dao.shoppingorderDAO.ShoppingOrderExt
