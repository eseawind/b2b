package com.saas.biz.dao.custrightsDAO;
...
public class CustlevelrightExt extends CustlevelrightDAO
{
  CustlevelrightDAO custlevelrightDAO = new CustlevelrightDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_b_custlevelright");
  ...
  public CustlevelrightDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    CustlevelrightDAO localCustlevelrightDAO = new CustlevelrightDAO();
    Field[] arrayOfField = localCustlevelrightDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localCustlevelrightDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localCustlevelrightDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_b_custlevelright");
 ...
 * Qualified Name:     com.saas.biz.dao.custrightsDAO.CustlevelrightExt
