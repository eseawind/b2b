package com.saas.biz.dao.shoppingcartDAO;
...
public class ShoppingCartExt extends ShoppingCartDAO
{
  private static final long serialVersionUID = 3435438429265830862L;
  ShoppingCartDAO shoporderDao = new ShoppingCartDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_shopping_cart");
  ...
  public ShoppingCartDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    Field[] arrayOfField = localShoppingCartDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localShoppingCartDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localShoppingCartDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_shopping_cart");
 ...
 * Qualified Name:     com.saas.biz.dao.shoppingcartDAO.ShoppingCartExt
