package com.saas.biz.dao.warnparamDAO;
...
public class WarnparamExt extends WarnparamDAO
{
  private static final long serialVersionUID = 7682398329993992745L;
  WarnparamDAO warnDao = new WarnparamDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_b_warnparam");
  ...
  public WarnparamDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    WarnparamDAO localWarnparamDAO = new WarnparamDAO();
    Field[] arrayOfField = localWarnparamDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localWarnparamDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localWarnparamDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_b_warnparam");
 ...
 * Qualified Name:     com.saas.biz.dao.warnparamDAO.WarnparamExt
