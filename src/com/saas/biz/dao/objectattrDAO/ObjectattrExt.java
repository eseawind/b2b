package com.saas.biz.dao.objectattrDAO;
...
public class ObjectattrExt extends ObjectattrDAO
{
  ObjectattrDAO objectattrDAO = new ObjectattrDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_objectattr");
  ...
  public ObjectattrDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    ObjectattrDAO localObjectattrDAO = new ObjectattrDAO();
    Field[] arrayOfField = localObjectattrDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localObjectattrDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localObjectattrDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_objectattr");
 ...
 * Qualified Name:     com.saas.biz.dao.objectattrDAO.ObjectattrExt
