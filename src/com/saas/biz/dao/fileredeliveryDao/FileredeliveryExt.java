package com.saas.biz.dao.fileredeliveryDao;
...
public class FileredeliveryExt extends FileredeliveryDAO
{
  FileredeliveryDAO fileredeliveryDAO = new FileredeliveryDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("fileredelivery");
  ...
  public FileredeliveryDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    FileredeliveryDAO localFileredeliveryDAO = new FileredeliveryDAO();
    Field[] arrayOfField = localFileredeliveryDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localFileredeliveryDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localFileredeliveryDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "fileredelivery");
 ...
 * Qualified Name:     com.saas.biz.dao.fileredeliveryDao.FileredeliveryExt
