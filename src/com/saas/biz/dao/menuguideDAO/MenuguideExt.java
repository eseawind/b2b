package com.saas.biz.dao.menuguideDAO;
...
public class MenuguideExt extends MenuguideDAO
{
  MenuguideDAO menuguideDao = new MenuguideDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("td_b_menuguide");
  ...
  public MenuguideDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    MenuguideDAO localMenuguideDAO = new MenuguideDAO();
    Field[] arrayOfField = localMenuguideDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localMenuguideDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localMenuguideDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "td_b_menuguide");
 ...
 * Qualified Name:     com.saas.biz.dao.menuguideDAO.MenuguideExt
