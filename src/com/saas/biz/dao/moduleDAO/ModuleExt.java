package com.saas.biz.dao.moduleDAO;
...
public class ModuleExt extends ModuleDAO
{
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("moduleinfo");
  ...
  public ModuleDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    Field[] arrayOfField = localModuleDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localModuleDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localModuleDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "moduleinfo");
  ...
  public ModuleDAO getFromBuffer(Buffers paramBuffers)
  {
    Dbexecute localDbexecute = new Dbexecute();
    String str = "com.saas.biz.dao.moduleDAO.ModuleDAO";
    ModuleDAO localModuleDAO = (ModuleDAO)localDbexecute.getFromBuffer(str, paramBuffers);
    return localModuleDAO;
  }
 ...
 * Qualified Name:     com.saas.biz.dao.moduleDAO.ModuleExt
