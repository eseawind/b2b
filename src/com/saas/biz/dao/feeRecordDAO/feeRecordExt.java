package com.saas.biz.dao.feeRecordDAO;

import com.saas.biz.commen.commMethodMgr;
import com.saas.biz.dao.factoriesDAO.FactoriesDAO;
...
public class feeRecordExt extends feeRecordDAO
{
  FactoriesDAO factoriesDAO = new FactoriesDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_fee_record");
  ...
  public feeRecordDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    feeRecordDAO localfeeRecordDAO = new feeRecordDAO();
    Field[] arrayOfField = localfeeRecordDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localfeeRecordDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localfeeRecordDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_fee_record");
 ...
 * Qualified Name:     com.saas.biz.dao.feeRecordDAO.feeRecordExt
