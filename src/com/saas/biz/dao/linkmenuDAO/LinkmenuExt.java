package com.saas.biz.dao.linkmenuDAO;
...
public class LinkmenuExt extends LinkmenuDAO
{
  LinkmenuDAO linkmenuDao = new LinkmenuDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("td_b_linkmenu");
  ...
  public LinkmenuDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    LinkmenuDAO localLinkmenuDAO = new LinkmenuDAO();
    Field[] arrayOfField = localLinkmenuDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localLinkmenuDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localLinkmenuDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "td_b_linkmenu");
 ...
 * Qualified Name:     com.saas.biz.dao.linkmenuDAO.LinkmenuExt
