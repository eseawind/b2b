package com.saas.biz.dao.salesOrderFormDAO;
...
public class SalesOrderExt extends SalesOrderDao
{
  private static final long serialVersionUID = 3435438429265830862L;
  SaleFormDAO saleDao = new SaleFormDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_saleform");
  ...
  public SaleFormDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    SaleFormDAO localSaleFormDAO = new SaleFormDAO();
    Field[] arrayOfField = localSaleFormDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localSaleFormDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localSaleFormDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_saleform");
 ...
 * Qualified Name:     com.saas.biz.dao.salesOrderFormDAO.SalesOrderExt
