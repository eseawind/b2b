package com.saas.biz.dao.clewInfoDAO;
...
public class ClewInfoExt extends ClewInfoDAO
{
  private static final long serialVersionUID = -7420230579458994185L;
  ClewInfoDAO clewDao = new ClewInfoDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_clewinfo");
  ...
  public ClewInfoDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    Field[] arrayOfField = localClewInfoDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localClewInfoDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localClewInfoDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_clewinfo");
 ...
 * Qualified Name:     com.saas.biz.dao.clewInfoDAO.ClewInfoExt
