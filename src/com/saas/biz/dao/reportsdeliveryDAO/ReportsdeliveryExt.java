...
public class ReportsdeliveryExt extends ReportsdeliveryDAO
{
  ReportsdeliveryDAO reportsdeliveryDao = new ReportsdeliveryDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("reportsdelivery");
  ...
  public ReportsdeliveryDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    ReportsdeliveryDAO localReportsdeliveryDAO = new ReportsdeliveryDAO();
    Field[] arrayOfField = localReportsdeliveryDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localReportsdeliveryDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localReportsdeliveryDAO, arrayOfField[i].getName(), localInteger);
            }
        }
    ...
    return localReportsdeliveryDAO;
  }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "reportsdelivery");
 ...
 * Qualified Name:     com.saas.biz.dao.reportsdeliveryDAO.ReportsdeliveryExt
