package com.saas.biz.dao.goodsTrackDAO;
...
public class GoodsTrackExt extends GoodsTrackDAO
{
  GoodsTrackDAO goodsTrackDao = new GoodsTrackDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_goods_track");
  ...
  public GoodsTrackDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    GoodsTrackDAO localGoodsTrackDAO = new GoodsTrackDAO();
    Field[] arrayOfField = localGoodsTrackDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localGoodsTrackDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localGoodsTrackDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_goods_track");
 ...
 * Qualified Name:     com.saas.biz.dao.goodsTrackDAO.GoodsTrackExt
