package com.saas.biz.dao.wareHousePosDAO;
...
public class WareHousePosExt extends WareHousePosDAO
{
  WareHousePosDAO wareHousePosDAO = new WareHousePosDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_warehouse_pos");
  ...
  public WareHousePosDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    WareHousePosDAO localWareHousePosDAO = new WareHousePosDAO();
    Field[] arrayOfField = localWareHousePosDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localWareHousePosDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localWareHousePosDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_warehouse_pos");
 ...
 * Qualified Name:     com.saas.biz.dao.wareHousePosDAO.WareHousePosExt
