package com.saas.biz.dao.storeformOutDAO;
...
public class StoreformOutExt extends StoreformOutDAO
{
  StoreformOutDAO storeformOutDao = new StoreformOutDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_storeform_out");
  ...
  public StoreformOutDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    StoreformOutDAO localStoreformOutDAO = new StoreformOutDAO();
    Field[] arrayOfField = localStoreformOutDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localStoreformOutDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localStoreformOutDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ...
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_storeform_out");
 ...
 * Qualified Name:     com.saas.biz.dao.storeformOutDAO.StoreformOutExt
