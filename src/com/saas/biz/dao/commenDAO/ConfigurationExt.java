...
public class ConfigurationExt extends ConfigurationDAO
{
  private static final long serialVersionUID = 5069278066016533273L;
  ConfigurationDAO comDao = new ConfigurationDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("td_s_configuration");
  ...
  public ConfigurationDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    ConfigurationDAO localConfigurationDAO = new ConfigurationDAO();
    Field[] arrayOfField = localConfigurationDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localConfigurationDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localConfigurationDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "td_s_configuration");
 ...
 * Qualified Name:     com.saas.biz.dao.commenDAO.ConfigurationExt
