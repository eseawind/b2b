...
public class EnttypeExt extends EnttypeDAO
{
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("td_s_enttype");
  ...
  public EnttypeDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    EnttypeDAO localEnttypeDAO = new EnttypeDAO();
    ArrayList localArrayList = new ArrayList();
    localDbexecute.setStrTable("td_s_enttype");
    localDbexecute.setStrQuery(paramString);
    localDbexecute.setParamList(this.paramArray);
    ...
    if (localArrayList.size() <= 0)
      return null;
    Field[] arrayOfField = localEnttypeDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localEnttypeDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localEnttypeDAO, arrayOfField[i].getName(), localInteger);
            }
        }
 ...
 * Qualified Name:     com.saas.biz.dao.commenDAO.EnttypeExt
