...
public class ProductDisTrackExt extends ProductDisTrackDAO
{
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_distribution_track");
  ...
  public ProductDisTrackDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    Field[] arrayOfField = localProductDisTrackDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localProductDisTrackDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localProductDisTrackDAO, arrayOfField[i].getName(), localInteger);
            }
        }
    ...
    return localProductDisTrackDAO;
  }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_distribution_track");
 ...
 * Qualified Name:     com.saas.biz.dao.productdistrackDAO.ProductDisTrackExt
