package com.saas.biz.dao.shoptaskDAO;
...
public class ShoptaskExt extends ShoptaskDAO
{
  private static final long serialVersionUID = 3435438429265830862L;
  ShoptaskDAO shoptaskDao = new ShoptaskDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_shoptask");
  ...
  public ShoptaskDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    ShoptaskDAO localShoptaskDAO = new ShoptaskDAO();
    Field[] arrayOfField = localShoptaskDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localShoptaskDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localShoptaskDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_shoptask");
 ...
 * Qualified Name:     com.saas.biz.dao.shoptaskDAO.ShoptaskExt
