package com.saas.biz.dao.userdetailDAO;
...
public class UserdetailExt extends UserdetailDAO
{
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_user_detail");
  ...
  public UserdetailDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    Field[] arrayOfField = localUserdetailDAO.getClass().getDeclaredFields();
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            if (arrayOfField[i].getType().getName() == "java.lang.String")
            {
              try
              {
                PropertyUtils.setProperty(localUserdetailDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
              }
            ...
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localUserdetailDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_user_detail");
 ...
 * Qualified Name:     com.saas.biz.dao.userdetailDAO.UserdetailExt
