package com.saas.biz.dao.enquirytrackDAO;
...
public class EnquirytrackExt extends EnquirytrackDAO
{
  EnquirytrackDAO enquirytrackdao;
  Logger log;
  ArrayList updArray;
  ArrayList paramArray;

  public EnquirytrackExt()
  {
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_b_enquiry");
  ...
  public EnquirytrackDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    EnquirytrackDAO localEnquirytrackDAO = new EnquirytrackDAO();
    Field[] arrayOfField = localEnquirytrackDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localEnquirytrackDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localEnquirytrackDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_b_enquiry");
 ...
 * Qualified Name:     com.saas.biz.dao.enquirytrackDAO.EnquirytrackExt
