package com.saas.biz.dao.stockQueryDAO;
...
public class StockQueryExt extends StockQueryDAO
{
  StockQueryDAO stockQueryDao = new StockQueryDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_stockquery");
  ...
  public StockQueryDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    StockQueryDAO localStockQueryDAO = new StockQueryDAO();
    Field[] arrayOfField = localStockQueryDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localStockQueryDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localStockQueryDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ...
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_stockquery");
 ...
 * Qualified Name:     com.saas.biz.dao.stockQueryDAO.StockQueryExt
