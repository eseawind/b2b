package com.saas.biz.dao.storeformInDAO;
...
public class StoreformInExt extends StoreformInDAO
{
  StoreformInDAO storeformInDao = new StoreformInDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_storeform_in");
  ...
  public StoreformInDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    StoreformInDAO localStoreformInDAO = new StoreformInDAO();
    Field[] arrayOfField = localStoreformInDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localStoreformInDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localStoreformInDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ...
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_storeform_in");
 ...
 * Qualified Name:     com.saas.biz.dao.storeformInDAO.StoreformInExt
