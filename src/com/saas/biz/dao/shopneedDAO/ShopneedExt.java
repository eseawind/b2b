package com.saas.biz.dao.shopneedDAO;
...
public class ShopneedExt extends ShopneedDAO
{
  private static final long serialVersionUID = 3435438429265830862L;
  ShopneedDAO shopneedDao = new ShopneedDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_shopneed");
  ...
  public ShopneedDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    ShopneedDAO localShopneedDAO = new ShopneedDAO();
    Field[] arrayOfField = localShopneedDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localShopneedDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localShopneedDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_shopneed");
 ...
 * Qualified Name:     com.saas.biz.dao.shopneedDAO.ShopneedExt
