package com.saas.biz.dao.clewAssignDAO;
...
public class ClewAssignExt extends ClewAssignkDAO
{
  private static final long serialVersionUID = 9209476084902172991L;
  ClewAssignkDAO clewDao = new ClewAssignkDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_clewtrackman");
  ...
  public ClewAssignkDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    Field[] arrayOfField = localClewAssignkDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localClewAssignkDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localClewAssignkDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_clewtrackman");
 ...
 * Qualified Name:     com.saas.biz.dao.clewAssignDAO.ClewAssignExt
