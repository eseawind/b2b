package com.saas.biz.dao.onlinehistoryDAO;
...
public class OnlinehistoryExt extends OnlinehistoryDAO
{
  OnlinehistoryDAO onlinehistoryDAO = new OnlinehistoryDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_f_online_history");
  ...
  public OnlinehistoryDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    OnlinehistoryDAO localOnlinehistoryDAO = new OnlinehistoryDAO();
    Field[] arrayOfField = localOnlinehistoryDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localOnlinehistoryDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localOnlinehistoryDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_f_online_history");
 ...
 * Qualified Name:     com.saas.biz.dao.onlinehistoryDAO.OnlinehistoryExt
