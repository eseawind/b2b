...
public class SaleOrderExt extends SaleOrderDAO
{
  private static final long serialVersionUID = 3435438429265830862L;
  SaleOrderDAO saleDao = new SaleOrderDAO();
  ...
  public ArrayList selByList(String paramString)
  {
    ...
    localDbexecute.setStrTable("tf_b_saleorder");
  ...
  public SaleOrderDAO selByInfo(String paramString)
  {
    Dbexecute localDbexecute = new Dbexecute();
    ...
    if (localArrayList.size() <= 0)
      return null;
    SaleOrderDAO localSaleOrderDAO = new SaleOrderDAO();
    Field[] arrayOfField = localSaleOrderDAO.getClass().getDeclaredFields();
      ...
      for (int i = 0; i <= arrayOfField.length - 1; i++)
      {
        ...
        try
        {
          if (localHashMap.get(arrayOfField[i].getName()) != null)
            ...
            {
              PropertyUtils.setProperty(localSaleOrderDAO, arrayOfField[i].getName(), localHashMap.get(arrayOfField[i].getName()).toString());
            }
            else if (arrayOfField[i].getType().getName() == "java.lang.Integer")
            {
              ...
              PropertyUtils.setProperty(localSaleOrderDAO, arrayOfField[i].getName(), localInteger);
            }
        }
  ...
  public ArrayList insBy(String paramString)
  {
    ArrayList localArrayList = new ArrayList();
    HashMap localHashMap = new HashMap();
    localHashMap.put("queryTable", "tf_b_saleorder");
 ...
 * Qualified Name:     com.saas.biz.dao.saleOrderDAO.SaleOrderExt
