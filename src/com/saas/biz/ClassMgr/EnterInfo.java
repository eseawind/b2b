...
public class EnterInfo extends Action
{
  ...
  public ArrayList GetEnterList(String paramString)
  {
    String str = "";
    if (paramString.equalsIgnoreCase("SEL_BY_ENTER"))
    {
      str = "select * from td_s_commpara where param_attr='" + this.param_attr + "'";
    ...
    try
    {
      ...
      {
        EnterInfo localEnterInfo = new EnterInfo();
        localEnterInfo.setPara_code1(localResultSet.getString("PARA_CODE1"));
        localEnterInfo.setPara_code2(localResultSet.getString("para_code2"));
        localArrayList.add(localEnterInfo);
      }
    }
  ...
  public EnterInfo[] GetList(ArrayList paramArrayList)
  {
    EnterInfo[] arrayOfEnterInfo = new EnterInfo[paramArrayList.size()];
    for (int i = 0; i < paramArrayList.size(); i++)
    {
      EnterInfo localEnterInfo = (EnterInfo)paramArrayList.get(i);
      arrayOfEnterInfo[i] = localEnterInfo;
    }
    return arrayOfEnterInfo;
  }

  public EnterInfo GetEnterInfo(String paramString)
  {
    String str = "";
    ...
    try
    {
      ...
      {
        localEnterInfo.setPara_code1(localResultSet.getString("para_code1"));
        localEnterInfo.setPara_code1(localResultSet.getString("para_code2"));
      }
    }
    catch (Exception localException)
    {
    ...
    this.DBQuery.CloseConn();
    return localEnterInfo;
  }
}

/* Location:           D:\project\代码\b2b-new-20090709\b2bv2-Pure-Simplify\WEB-INF\classes\
 * Qualified Name:     com.saas.biz.ClassMgr.EnterInfo
