...
public class TradeCheck
  implements TradeCheckIntf
{
  Logger log = new Logger(this);
  Buffers outBuffer = new Buffers();

  public ArrayList ExecTradeCheck(Buffers paramBuffers)
  {
    ...
    localTradeTypeDAO.setParam(":VTRADETYPECODE", "0900");
    ...
    localBpmDefinitionDAO.setParam(":VTRADETYPECODE", "0900");
    ...
    try
    {
      ...
      if (this.outBuffer.getInt("RESULT_CODE") == 0)
 ...
 * Qualified Name:     com.saas.sys.bpm.TradeCheck
