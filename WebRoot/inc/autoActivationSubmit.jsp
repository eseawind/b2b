...
<div id="login_body">
	<div id="login_box">
		<div class="login_lmt">
			<div class="lmt1">验证成功</div>
		</div>
		
		<div class="reg_mail">
			<div class="reg_mail_img"><img src="/templates/default/images/mail_yanzhen.gif" width="164" height="150"></div>
			<div class="reg_mail_img_bg">恭喜您，邮箱验证成功！</div>
		</div>
	</div>
