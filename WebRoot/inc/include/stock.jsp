...
<%
	...
	if(precision.equals("0")){
		...
		pageTools = tools.getGoogleToolsBar(counter,"stock.jsp?param1=" + key + "&param2=" + pro + "&param3=" + city + "&param4=" + part + "&iStart=", Integer.parseInt(iStart) , 30);
	}else if(precision.equals("1")){
		list = info.getSearchStockList(Integer.valueOf(iStart).intValue(),30,key,pro_name,city_name,Integer.parseInt(part));
		counter = info.getSearchStockList(key,pro,city,Integer.parseInt(part));
		pageTools = tools.getGoogleToolsBar(counter, "stock.jsp?param1=" + key + "&param2=" + pro + "&param3=" + city + "&param4=" + part + "&iStart=", Integer.parseInt(iStart) , 30);
	}
%>
