        ...
        <TR>
          <TD align=left colSpan=5 height=80>
            ...
            <UL>
             ...
             <LI id=list1>下面将自动转入登录页面，请登录系统完善详细的客户资料，开始正式使用本系统，<br>
                <a  href="/index.jsp">如果您的浏览器没有自动转入登录页面，请点此链接</a></LI><br>
            
             </UL>
            <DIV align=right><BR>
            如有其他疑问，请联系我们的客服：<a href="http://www.21oil.com">http://www.21oil.com</a> 电话:400－810-7818 </DIV></TD></TR>
        <TR>
