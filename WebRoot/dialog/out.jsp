        ...
        <TR>
          <TD align=left colSpan=5 height=80>
            ...
            <UL>
             ...
             <LI id=list1> <a href="/index.jsp" style="font-SIZE:13px">更换帐号，重新登录系统</a> </LI><br>
             <!--LI id=list1> <a href="#" onclick="closeit()" style="font-SIZE:13px">离开系统，关闭浏览器</a> </LI><br-->
          
            
             </UL>
            <DIV align=right><BR>
            <font color=#ff0000><strong>如有其他疑问，请联系我们的客服电话:0374-69167839     69167829 </strong></font></DIV></TD></TR>
        <TR>
