			...
			<tr>
				<td>
					<table width="800" border=0 cellpadding=1 cellspacing=1 align=center bgcolor="#DEEDFD">
						...
						<%	
								String ch_id = "", ch_name = "",ch_desc="",up_ch_id="",ch_level="",up_ch_name="",ch_attr="",class_type="";
								ArrayList downList = new ArrayList();
								if (classlist != null && classlist.size() > 0) {
									for (int a = 0; a < classlist.size(); a++) {
										HashMap class_map = (HashMap) classlist.get(a);
										if (class_map.get("class_type") != null) {
											class_type = class_map.get("class_type").toString();
										}
						...
						<tr class="u2">
							...
							<td align=center>
								<a href="viewClassNewsInfo.jsp?class_id=<%=ch_id%>&class_type=""<%=class_type%>" target="_blank"><img src="/images/view.gif" border="0"></a>
							</td>
							<td align=center>
								<%
									if(ch_attr.equals("1")){
