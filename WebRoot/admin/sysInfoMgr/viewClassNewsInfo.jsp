...
<%
	...
	ArrayList newsList = bean.getNewsListByCustId(Integer.valueOf(
		...
		<form action="viewClassNewsInfo.jsp" method="post" name="searchForm">
			...
			<table width="800" border=0 cellpadding=1 cellspacing=1 align=center bgcolor="#DEEDFD">
				...
				<tr class="u2">
					...
					<td align=center>
						<a href="modifyNewsInfo.jsp?news_id=<%=news_id%>&class_type=<%=class_type%>" TARGET="_blank"><img src=/images/edit.gif width=16 height=16 border=0 alt="修改资讯信息"> </a>
					</td>
