			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" align="center">
				<tr>
					<td>
						...
						<!--02-->
						<table width="100%" border=0 align="center" cellpadding=1 cellspacing=1 bgcolor="#FCB0B0" id="bo0">
							<tr>
								<td width="111" class="u1">
									信息标题：
								</td>
								<td width="278" class="u2">
									<input name="title" id="title" type="text" value="<%=title%>" size=80 maxlength=70>
								</td>
							</tr>
							<tr>
								<td class="u1">
								...
								<td width="85%" align=left style="background-color:#ffffff; color:#000000;  font-size:12px;">
									<iframe marginWidth="0" marginHeight="0" src="displayClassName.jsp?class_type=<%=type%>" frameborder=0 scrolling=no width=630 height="510"></iframe>
									<input name="news_id" type="hidden" value=<%=news_id%>>
									<input name="subject_tag" type="hidden" value=0>
									<input name="news_type" type="hidden" value="<%=type%>" id="news_type">
								</td>
							</tr>
							<tr>
								<td class="u1">
						...
						<table width="100%" border=0 align="center" cellpadding=1 cellspacing=1 bgcolor="#FCB0B0">
							<tr>
