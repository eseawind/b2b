				        ...
				        <%i++;
					     ...
					     %>
					      <tr>
										...
										<a href="enquiryInfoList.jsp?iStart=0">首页 </a>&nbsp; &nbsp;
										<% 
											if(Integer.parseInt(iStart)>0){
										%>
											<a href="enquiryInfoList.jsp?iStart=<%=pageUp%>">上一页</a> &nbsp;
										<%
											}
											if(Integer.parseInt(iStart)<pages-1){
										%>
											<a href="enquiryInfoList.jsp?iStart=<%=pageDown%>">下一页 </a>&nbsp; 
										<%
											}
										%>
										<a  href="enquiryInfoList.jsp?iStart=<%=pages-1%>">尾页</a></td>
							    </tr>
					     <%
		            }
		        %>
