	  ...
	  <TD valign="bottom">
						<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								...
								<tr>
										...
										<img src="/admin/images/tophome.gif" align="absmiddle" border="0" />&nbsp;&nbsp;
			...
			<TBODY>
				<TR>
					<TD width="79%" align="left">
						...
						<%=user_name%>
						登录我的商务室 </font>  
						<A target="_parent" href="/admin/out.jsp"><font color="#ffffff">[退出]</font> </A>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<A target="_blank" href="/admin/help/"><font color="#ffffff">[帮助]</font> </A>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
