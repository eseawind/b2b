...
<%
  ...
  ArrayList secMenuList = new RightMenu().getMenuRight(0,subsys_code,"3"); //获取三级栏目内容供后面内存操作筛选 ， 杨杰明修改 2011-07-21
...
<table width="150" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td style="border-right:#FCB0B0 1px solid; background-color:#FDF8F8;">
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
			<TR>
				<TD align="center" height="30"><A  href="/admin/mainMenu/home.jsp" target="main"><img src="<%=request.getContextPath()%>/admin/mainMenu/images/backhome.gif" alt="Business page" width="133" height="27" border="0"></A></TD>
			</TR>
			<%
			 String path=request.getContextPath();
			  if(firstMenuList!=null && firstMenuList.size()>0)
			  {
			    ...
			    for(int i=0;i<firstMenuList.size();i++)
				{
			      ...
			      String image="/admin/mainMenu/images/1.gif",display="display:none";
			      if(i==0)
				  {
			        image="/admin/mainMenu/images/_1.gif";
					...
					<table width="100%">
						...
						if(children!=null && children.size()>0)
						{
						 ...
						 <%}else if(null!=threechild){
						 	  String image3="/admin/mainMenu/images/1.gif";
						 	%>
						 <tr>
...
<script language="javascript" id="clientEventHandlersJS">
			...
			function LMYC() 
			{
				...
				for (i=0;i<number;i++) 
				{
					...
					treePic.src = '/admin/mainMenu/images/1.gif';
			...
			function ShowFLT(i) 
			{
				...
				{
					LMYC();
					treePic.src = '/admin/mainMenu/images/_1.gif';
					lbmc.style.display = '';
				}
				else 
				{
			...
			function ShowChild3(number3,val,vl)
			{
				...
				if(isrc.indexOf("_")>0){
					document.getElementById('image3'+val+''+vl).src = '/admin/mainMenu/images/1.gif';
					for (i=0;i<number3;i++){
						document.getElementById('childt'+i+val+''+vl).style.display = 'none';
						}
				}
				else{
					document.getElementById('image3'+val+''+vl).src = '/admin/mainMenu/images/_1.gif';
					for(j=0;j<number3;j++){
