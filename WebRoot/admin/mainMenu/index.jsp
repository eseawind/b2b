				...
				<tr>
					<td>
						<%
							...
							thirdMenuList = new RightMenu().genchildRightMenuList("1","3", up_menu_id, user_class, role_code, user_type);
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
							  <td height="500">
									...
									<TABLE style="BORDER: #0066CC 1px solid;" cellSpacing="0" cellPadding="8" width="100%" align="center" border="0">
										<TBODY>
											<TR>
