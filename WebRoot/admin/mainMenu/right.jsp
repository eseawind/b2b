...
.t3 a:hover{color: #ffffff;text-decoration: underline; font-size:14px; font-weight:bold;}
    ...
    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" >
			<tr align="left" style="background:url(/admin/mainMenu/images/left_03.gif);">
				<td width="8%" height="31">&nbsp;<img src="/admin/mainMenu/images/tb.jpg" align="absmiddle"/></td>
	       ...
	       %>
                     <TR>
								<TD width="5%"><img src="/admin/mainMenu/images/lujian_1.gif" align="absmiddle"/>		</TD>
   ...
   <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0">
			<tr align="left" style="background:url(/admin/mainMenu/images/left_03.gif);">
				<td width="8%" height="28">&nbsp;<img src="/admin/mainMenu/images/tb.jpg" align="absmiddle"/></td>
		      <td width="92%" class="t3"><a href="/<%=save_dir%>" target="_blank" ><%=ch_name%></a></td></tr></table>
              <table width="96%" align="center">
            <%
