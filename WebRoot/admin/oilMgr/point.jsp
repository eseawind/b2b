...
<%
    ...
    String point_id = comm.GenTradeId();
						...
						<table width=727 border=0 cellpadding=5 cellspacing=1 align=center bgcolor="#dddddd">
							<tr>
								...
								<td align=left bgcolor="#FFFFFF">
									<div class="ping">
										<input name="point_name" id="point_name" type="text" size="25" maxlength="25">
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align=left bgcolor="#FFFFFF">
									<div class="ping">
										<input name="now_num" id="now_num" type="text" size="15" maxlength="15">
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align=left bgcolor="#FFFFFF">
									<div class="ping">
										<input name="ud_num" id="ud_num" type="text" size="15" maxlength="15">
									</div>
								</td>
							</tr>
							<tr>
								...
								<td align=left bgcolor="#FFFFFF">
									<div class="ping1">
										...
										<input name="trade_type_code" type="hidden" value="6003">
							...
							<tr>
								<td style="background-color:#f6f6f6; color:#000000;  font-weight:bold; font-size:12px;padding-top:10px;padding-bottom:10px;" align="center" colspan=2>
									<input name="comit" type="submit" value="" onclick="return pointconfirmsub()" style="background-image: url('/images/tj.gif');width:70px;height: 26px;border:0;cursor:hand">
								</td>
							</tr>
						</table>
					</td>
