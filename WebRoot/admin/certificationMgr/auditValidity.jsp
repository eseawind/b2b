				...
				<tr>
					<td valign="top">
						<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td background="/admin/images/content_03.gif" height="43" width="156" align="center"><font size="2"><b>信息审核</b></font></td>
						...
						<table width=800 border=0 cellpadding=1 cellspacing=1 align=center bgcolor="#efefef">
							<tr>
								...
								<td style="background-color: #ffffff; color: #000000; font-weight: bold; font-size: 12px; text-align: left" >
									<div>
										<%=para_code2%>
									</div>
								</td>
							...
							<tr>
								...
								<td style="background-color: #ffffff; color: #000000; font-weight: bold; font-size: 12px; text-align: left"  colspan="3">
									<div>
