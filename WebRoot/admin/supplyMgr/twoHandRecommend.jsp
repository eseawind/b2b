...
<%
	...
	ArrayList saleList = new ArrayList();
		...
		saleList = saleObj.twohandCommend(Integer.valueOf(iStart).intValue(), 10);
		counter = saleObj.twohandCommend();

	String pageTools=tools.getPageTools(String.valueOf(counter),"10","twoHandRecommend.jsp?iStart=",Integer.parseInt(iStart));
%>
<html>
	<head>
	...
	<form action="modifyIndex.jsp" method="post" name="indexdateform">
      ...
      <tr>
			  <td background="/admin/images/content_03.gif" height="43" width="156" align="center"><font size="2"><b>二手推荐</b></font></td>
       ...
       <%}else{%>
	      <td  align=center>
					<a href=/doTradeReg.do?cust_id=<%=info_id%>&trade_type_code=2323 TARGET=_self><img src=/images/edit.gif width=16 height=16 border=0 alt="二手推荐">
					</a>
				</td>
