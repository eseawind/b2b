  ...
  <form  name="classForm" method="post" action="/doTradeReg.do" target="_bank">
		<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
			<tr><td>
				  ...
				  <table width="98%" border=0 cellpadding=1 cellspacing=1 align=center bgcolor="#DEEDFD">
						<tr>
							<td class="u1" align="right">二手产品标题：</td>
							<td class="u2" colspan="3"><%=title%>
							</td>
						</tr>
										
						<tr>
							<td class="u1" width="15%">发布单位：</td>
							<td class="u2" width="35%">
									<a href="/member/customerMgr/companyIntroduction.jsp?obj_cust_id=<%=cust_id%>"><%=cust_name%></a>
							</td>
							<td class="u1" width="15%">销售地点：</td>
							<td class="u2"width="35%">
								<%=sale_addr%>
							</td>
						</tr>
