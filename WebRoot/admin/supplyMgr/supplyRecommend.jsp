...
<html>
	...
	<form action="modifyIndex.jsp" method="post" name="indexdateform">
      ...
      <tr>
			  <td background="/admin/images/content_03.gif" height="43" width="156" align="center"><font size="2"><b>供应推荐</b></font></td>
       ...
       <%}else{%>
	      <td  align=center>
					<a href=/doTradeReg.do?cust_id=<%=info_id%>&trade_type_code=2323 target="_self"><img src=/images/edit.gif width=16 height=16 border=0 alt="供应推荐">
					</a>
				</td>
