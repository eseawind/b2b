...
<%
	    ...
	    if(it.equals("1")){
			...
			ArrayList tableList = product.getAllProductInfoById(Integer.parseInt(iStart));
			int counter = product.getAllProductInfoById();
			if(!pro_name.equals("")){
			...
			<tr class="u1">
				<td colspan=3 align="left" class="head">
					...
					<table width=100% border=0 cellpadding=2 cellspacing=1 bgcolor="#e7e7e7">
						<tr>
							<td style="background-color: #FCB0B0; color: #000000; font-weight: bold; font-size: 13px;" align=left width="20%">
								产品名称
							</td>
							<td style="background-color: #FCB0B0; color: #000000; font-weight: bold; font-size: 13px;" align=left width="20%">
								产品简介
							...
							<td style="background-color: #FCB0B0; color: #000000; font-weight: bold; font-size: 13px;" align=left width="10%">
								发布日期
							</td>
							<td style="background-color: #FCB0B0; color: #000000; font-weight: bold; font-size: 13px;" align=center width="5%">
								修改
							</td>
							<!--td style="background-color: #FCB0B0; color: #000000; font-weight: bold; font-size: 13px;" align=center width="5%">
								删除
							</td-->
							<td style="background-color: #FCB0B0; color: #000000; font-weight: bold; font-size: 13px;" align=center width="20%">
