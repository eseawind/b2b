 ...
 <html>
	<head>
		...
		<script language="javascript">
			...
			var div = document.getElementById("param_attr").value;
			var reg = /^\-?([1-9]\d*|0)(\.\d+)?$/; 
			if(!reg.test(div)) 
			{ 
				    alert('参数代码只能是数字');
						...
						<table width=100% border=0 cellpadding=0 cellspacing=1 bgcolor="#dddddd" align="center">	
							...
							<tr>
								...
								<td style="background-color:#ffffff; color:#000000;  font-size:12px;padding:5px;" align=left>
									<input name=subsys_code type=text value="" size="30" maxlength="3"><font color="red">*</font>
								</td>
								...
								<td style="background-color:#ffffff; color:#000000;  font-size:12px;padding:5px;" align=left>
									<input name=param_attr type=text id=param_attr value="" size="30"   ><font color="red">*</font>
								</td>
							...
							<tr>
								...
								<td style="background-color:#ffffff; color:#000000;  font-size:12px;padding:5px;" align=left>
									<input name="param_code" type="text" id="param_code" value=""><font color="red">*</font>
								</td>
