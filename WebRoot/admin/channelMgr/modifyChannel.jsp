...
<%
	...
	if(list != null && list.size() > 0){
		...
		cont_mod = comm.getItemsBySelected("118",cont_mod);
	}
	...
	String up_save_dir="";
	if(!up_ch_id.equals("")){
		ArrayList up_list = info.getChannel(up_ch_id); 
			...
			<div id="sale-list" style="display:block" align="center">
				<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" bgcolor="#dddddd">
					...
					<tr>
						...
						<td bgcolor="#FFFFFF">
							<div class="ping1">
								<input name="save_dir" type="text" id="save_dir" value="<%=save_dir%>" size="50" maxlength="100">
								<input name="save_dir_cc" type="hidden" id="save_dir_cc" value="<%=save_dir%>" size="50" maxlength="100">
					...
					<tr>
						...
						<td bgcolor="#FFFFFF">
							<div class="ping1">
								<input type="text" name="article_temp" id="article_temp" value="<%=article_temp%>" size="40" maxlength="100">
					...
					<tr>
						...
						<td bgcolor="#FFFFFF">
							<div class="ping1">
								<textarea id="ch_key" name="ch_key" rows="6" cols="50"><%=ch_key%></textarea>
							</div>
						</td>
						<td bgcolor="#ffffff">
							<div style="text-align:right; font-weight:bold;">
						...
						<td bgcolor="#FFFFFF">
							<div class="ping1">
								<textarea id="ch_desc" name="ch_desc" rows="6" cols="50"><%=ch_desc%></textarea>
							</div>
						</td>
					</tr>
					<tr>
					<td bgcolor="#FFFFFF" align="center" height="50" colspan="4">
						<input name="trade_type_code" type="hidden" id="trade_type_code" value="0009">
