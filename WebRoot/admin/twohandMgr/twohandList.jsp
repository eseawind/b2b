...
<%
	...
	if("1".equals(code)){
		...
		saleList = saleObj.gentSalesByCust_id(Integer.valueOf(iStart).intValue(), cust_id,"1");
		counter = saleObj.getSaleListNumber(cust_id,"1");
	}
...
<html>
	...
	<%
		...
		<table  width=100% border=0 cellpadding=1 cellspacing=1 bgcolor="#FCB0B0" align="center">
				<tr class="u2">
				<td >
