		...
		<form name="menuForm" id="menuForm" action="/doTradeReg.do" method="post" target="_self">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" bgcolor="#dddddd">
				...
				<tr>
					...
					<td width="35%" bgcolor="#FFFFFF">
						<div class="ping1">
							...
							<input name="menu_name" type="text" id="menu_name" value="" size="18" maxlength="30">
				...
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<div class="ping1">
							<input name="module_id" type="text" id="module_id" value="" size="15" maxlength="20">
						</div>
					</td>
					<td bgcolor="#ffffff">
						<div style="text-align:right; font-weight:bold;">
				...
				<tr>
					<td bgcolor="#FFFFFF" align="center" height="50" colspan="4">
						...
						<img src="/admin/images/submit_1.gif" onClick="location.href='index.jsp?sel_sys=<%=subsys_code%>&menu_class=<%=menu_class%>'" style="cursor:hand;" align="absmiddle">
					</td>
				</tr>
			</table>
		</form>
