		...
		<form name="menuForm" id="menuForm" action="/doTradeReg.do" method="post" target="_self">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" bgcolor="#dddddd">
				...
				<tr>
					...
					<td width="35%" bgcolor="#FFFFFF">
						<div class="ping1">
							<input name="subsys_code" type="text" id="subsys_code" value="<%=subsys_code%>" maxlength="8">
						</div>
					</td>
					...
					<td width="35%" bgcolor="#FFFFFF">
						<div class="ping1">
							...
							<input name="menu_name" type="text" id="menu_name" value="<%=menu_name%>" size="18" maxlength="30" onblur="javascript:document.getElementById('module_name').value=this.value;">
			...
			<table width="800" border="0" cellspacing="1" cellpadding="0" align="center" bgcolor="#dddddd">
				...
				<tr>
					...
					<td width="35%" bgcolor="#FFFFFF">
						<div class="ping1">
							<input name="module_name" type="text" id="module_name" value="<%=module_name%>" maxlength="100" size="20">
							<img src="/admin/images/hot_l.gif" border="0">
						</div>
					</td>
					...
					<td width="35%" bgcolor="#FFFFFF">
						<div class="ping1">
							<input name="module_file" type="text" id="module_file" value="<%=module_file%>" size="30" maxlength="100">
							<img src="/admin/images/hot_l.gif" border="0">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<div class="ping1">
							<input name="module_dir" type="text" id="module_dir" value="<%=module_dir%>" size="30" maxlength="100">
							<img src="/admin/images/hot_l.gif" border="0">
						</div>
					</td>
					<td bgcolor="#ffffff">
					...
					<td bgcolor="#FFFFFF">
						<div class="ping1">
							<input name="module_type" type="text" id="module_type" value="<%=module_type%>" size="10" maxlength="1">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<div class="ping1">
							<input name="rsrv_str1" type="text" id="rsrv_str1" value="<%=m_rsrv_str1%>" size="20" maxlength="20">
						</div>
					</td>
					<td bgcolor="#efefef">
						<div style="text-align:right; font-weight:bold;">
					...
					<td bgcolor="#FFFFFF">
						<div class="ping1">
							<input name="rsrv_str2" type="text" id="rsrv_str2" value="<%=m_rsrv_str2%>" size="20" maxlength="100">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<div class="ping1">
							<input name="rsrv_str3" type="text" id="rsrv_str3" value="<%=m_rsrv_str3%>" size="20" maxlength="100">
						</div>
					</td>
					<td bgcolor="#ffffff">
						<div style="text-align:right; font-weight:bold;">
					...
					<td bgcolor="#FFFFFF">
						<div class="ping1">
							<input name="rsrv_str4" type="text" id="rsrv_str4" value="<%=m_rsrv_str4%>" size="20" maxlength="100">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<div class="ping1">
							<input name="rsrv_str5" type="text" id="rsrv_str5" value="<%=m_rsrv_str5%>" size="15" maxlength="1">
						</div>
					</td>
					<td bgcolor="#efefef">
						<div style="text-align:right; font-weight:bold;">
					...
					<td bgcolor="#FFFFFF">
						<div class="ping1">
							<input name="rsrv_str6" type="text" id="rsrv_str6" value="<%=m_rsrv_str6%>" size="15" maxlength="1">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<div class="ping1">
							<input name="rsrv_str7" type="text" id="rsrv_str7" value="<%=m_rsrv_str7%>" size="15" maxlength="1">
						</div>
					</td>
					<td bgcolor="#ffffff">
						<div style="text-align:right; font-weight:bold;">
					...
					<td bgcolor="#FFFFFF">
						<div class="ping1">
							<input name="rsrv_str8" type="text" id="rsrv_str8" value="<%=m_rsrv_str8%>" size="15" maxlength="1">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td bgcolor="#FFFFFF">
						<div class="ping1">
							<input name="rsrv_str9" type="text" id="rsrv_str9" value="<%=m_rsrv_str9%>" size="30" maxlength="100">
						</div>
					</td>
					<td bgcolor="#efefef">
						<div style="text-align:right; font-weight:bold;">
					...
					<td bgcolor="#FFFFFF">
						<div class="ping1">
							<input name="rsrv_str0" type="text" id="rsrv_str0" value="<%=m_rsrv_str0%>" size="30" maxlength="100">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td bgcolor="#FFFFFF" colspan="3">
						<div class="ping1">
							<input name="remark" type="text" id="remark" value="<%=m_remark%>" size="52" maxlength="50">
						</div>
					</td>
				</tr>
				<tr>
					<td bgcolor="#FFFFFF" align="center" height="50" colspan="4">
						...
						<img src="/admin/images/submit_1.gif" onClick="location.href='index.jsp?up_menu_id=63WS0yTCs424j24&menu_class=<%=menu_class%>&sel_sys=<%=subsys_code%>'" style="cursor:hand;" align="absmiddle">
					</td>
				</tr>
			</table>
		</form>
