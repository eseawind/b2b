...
//设置一级分类
	...
	function cretateSelect(index,value)
	{
	 ...
	 document.getElementById(index).innerHTML="<select name=sort"+index+" id=sort"+index+" size=3 onchange=cretateSelect("+divId+",this.value)  onclick=setTypeName(this.value) style=width:130px></select><div id="+divId+"></div>";
...
%>
     ...
     <table width="100%" border="0" cellpadding="1" cellspacing="1" align="center"  bgcolor="#FCB0B0">
      <tr>
		  ...
		  <td class="u2">
                  ...
                  <option value="5">子分类</option>
              </select>
                   
		  </td>
	 </tr>
	 <tr id="typeInfo" height="30" style="display:none">
         ...
         <td class="u2">
          <table border="0" cellpadding="0" cellspacing="0">
             ...
             <tr>
								...
								<td>
									<select name="sort2" id="sort2" size="10" style="width: 130px; display: none"
								...
								<td>
									<select name="sort3" id="sort3" size="10" style="width: 130px; display: none"
		...
		<tr>
		 ...
		 <input name="class_type" id="class_type" type="hidden" value="5">
    ...
    <tr>
				<td height="30" colspan="2" align="center" class="u3">
