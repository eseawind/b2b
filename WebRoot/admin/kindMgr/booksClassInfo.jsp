...
.line6 {width:72spx; width:70spx!important;border:#ffcb99 1px solid;  background-color:#fff8ee; text-align:left; padding-left: 20px;padding-top: 11px;padding-bottom: 11px; color:#000000; margin-top:13px; margin-bottom:13px;}   /*横栏样式6---- 头部提醒1*/
...
<%
	...
	String book_id= bean.GenTradeId();
...
<form  name="classForm" method="post" action="/doTradeReg.do" target="_self">
     ...
     <table width="100%" border="0" cellpadding="1" cellspacing="1" align="center" bgcolor="#FCB0B0">
        <tr>
		 <td class="u1">分类类型</td>
		  <td class="u2">
			<select name="classlevel" id="classlevel" style="width:110px" onChange="selectLevel(this.value)">
        <option value="0">主分类</option>
        <option value="11">子分类</option>
      </select>  
		  </td>
	 </tr>
	 <tr id="typeInfo" style="display:none">
                  ...
                  <tr>
								...
								<td>
									<select name="sort3" size="10" style="width: 130px; display: none"
										...
										onchange="cretateSelect('4',this.value)" onkeydown="down(this.value);" onkeyup="down(this.value);">
										<option value="0">
											请选择...
										</option>
									</select>
								...
								<td>
								 <div id="nextElement">
									<div id="4" style="width;110px; float:left;display:inline;white-space:nowrap"></div>
		...
		<tr>
		 <td class="u1">分类名称</td>
		  <td class="u2">
					<input name="class_name" type="text" maxlength="10">
		  </td>
		</tr>
		<tr>
		 ...
		 <input name="book_title" type="hidden" value="">
		 <input name="enable_tag" type="hidden" value="0">
		 <input name="class_type" type="hidden" value="11">
		 <input type="hidden" name="up_class_id" id="up_class_id"  value="000000000000000">
