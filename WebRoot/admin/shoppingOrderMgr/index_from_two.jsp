...
<body>	
	<form action="index.jsp" method="post" name="orderform">
		...
		<table width="720" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#BED9E1">
		  <tr>
...
<br><table bgcolor="#BED9E1" width=720 border=0 cellpadding=2 cellspacing=1 align="center">
		    	<tr>
		    		<td bgcolor="#FFFFFF">
						<br>
						<table width="84%" border="0" align="center" cellpadding="0" cellspacing="0" class="menu_from">
                          <tr>
                            <td width="17%" align="right">服务：</td>
                            <td width="30%"><label>
                              <input name="textfield" type="text" size="20">
                            </label></td>
                            <td width="18%" align="right">服务名：</td>
                            <td width="35%"><input name="textfield5" type="text" size="20"></td>
                          </tr>
                          <tr>
                            <td align="right">菜单ID：</td>
                            <td><input name="textfield2" type="text" size="20"></td>
                            <td align="right">文件路径：</td>
                            <td><input name="textfield6" type="text" size="20"></td>
                          </tr>
                          <tr>
                            <td align="right">菜单名：</td>
                            <td><input name="textfield3" type="text" size="20"></td>
                            <td align="right">文件名：</td>
                            <td><input name="textfield7" type="text" size="20"></td>
                          </tr>
                          <tr>
                            <td align="right">级别：</td>
                            <td><input name="textfield4" type="text" size="20"></td>
                            <td align="right">模板ID：</td>
                            <td><input name="textfield8" type="text" size="20"></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td colspan="3"><img src="../images/submit_0.gif" width="80" height="26"></td>
                          </tr>
                      </table>
						<br>
				  </td>
