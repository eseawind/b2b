...
<%
    ...
    String trade_id = "",root_id="",cust_id="",user_name = "",word_status="",title = "",content="",in_date = "";
  ...
  {    
        ...
        if( map.get( "fuser_name" ) != null )
        {
           user_name = map.get( "fuser_name" ).toString();
        }
...
<body>
		<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
				<td background="/admin/images/content_03.gif" height="43" width="156" align="center"><font size="2"><b>客户意见</b></font></td>
		       ...
		       <table width=800 border=0 cellpadding=2 cellspacing=1 align=center bgcolor="#dddddd">
		        <tr>
			        <td class="u1" width="20%">发件人:</td>
			        <td style=" color:#000000;background-color:#FFFFFF" colspan="2" align=left><%=user_name%>  </td>
		         </tr>
			      <tr>  
							 <td class="u1">时间:</td>
