...
<%
  ...
  ArrayList leaveList = leavewords.getLeaveMemberByRootId(Integer.valueOf(iStart).intValue() ,cust_id,root_id);
  int counter = leavewords.getLeaveMemberByRootId(cust_id,root_id);
	...
	<body>
		...
		<table width=100% border=0 cellpadding=1 cellspacing=1 align=center
			...
			<tr class="u2">
				...
				<td align=left>					
						<a href="/doTradeReg.do?trade_id=<%=trade_id%>&trade_type_code=6546" target="_self"><img src="/images/del.gif" border="0" alt="删除已发邮件"></a>
				</td>
			<%
					i++;
					}
