...
function checkInfo(){
	...
	if(document.classForm.password.value.replace(/\s*/g,"") =="" || document.classForm.password==null){
		alert("新密码不能为空！");
		document.classForm.password.focus();
		return false;
	}
	...
	<body>
		<%
			...
			String user_name = "",  passwd = "",user_id = "";
		...
		<form name="classForm" method="post" action="/doTradeReg.do" target="_self">
			...
			<table width="100%" border="0" cellpadding="1" cellspacing="1" align="center" bgcolor="#DEEDFD">
				...
				<center>
						...
						<input name="trade_type_code" type="hidden" value="6010">
					</table>
					<table>
						<tr>
						<tr>
				...
				<tr>
					...
					<td>&nbsp;&nbsp;&nbsp;<img src="/admin/images/comeback.JPG" border="0" onclick="javascript:window.location.href='modifyUserPsd.jsp';" style="cursor:hand;">
					</td>
				</tr>
			</table>
		</form>
