...
<jsp:include page="/inc/jspTop.jsp">
			<jsp:param name="menu_id" value="78RDxEf554e5626f130J" />
		</jsp:include>	
	    ...
	    <td>
		     ...
		     <table width=800 border=0 cellpadding=2 cellspacing=1 align=center bgcolor="#e7e7e7">
		        ...
		        <tr>
			        ...
			        <td background="/images/newsbg.gif" style="color:#000000;  font-weight:bold; font-size:13px;"  align=center width="15%">用户名</td>

					<td background="/images/newsbg.gif" style="color:#000000;  font-weight:bold; font-size:13px;" align=center width="10%">性别</td>

					<td background="/images/newsbg.gif" style="color:#000000;  font-weight:bold; font-size:13px;" align=center width="15%">电话</td>

					<td background="/images/newsbg.gif" style="color:#000000;  font-weight:bold; font-size:13px;" align=center width="15%">出生日期</td>

					<td background="/images/newsbg.gif" style="color:#000000;  font-weight:bold; font-size:13px;" align=center width="35%">地址</td>

					<td background="/images/newsbg.gif" style="color:#000000;  font-weight:bold; font-size:13px;" align=center width="10%" >冻结</td>
		            ...
		            {   int i=0;
...

		                  {
						        ...
						        <tr style="background-color:#f9f9f9; " id="changcolor_tr<%=i%>" onmouseover="MM_changeProp('changcolor_tr<%=i%>','','backgroundColor','#ffffff','DIV')" onmouseout="MM_changeProp('changcolor_tr<%=i%>','','backgroundColor','#f9f9f9','DIV')">
					              ...
					              <td  style=" color:#000000;" align=center><a href=/doTradeReg.do?user_state=1&user_id=<%=user_id%>&trade_type_code=0285 target="_self"  onClick="return frostUserListchechIfo()"><img src=/img/frost.gif width=16 height=16 border=0></a></td>
