...
<html>
	...
	<body>
		<table width="100%"  style="display:none" border=0 align="center" cellpadding=1 cellspacing=1 bgcolor="#DEEDFD" id="bo1">
			<tr>
				<!--td width="111" class="u1">
					信息标题：
				</td>
				<td width="278" class="u2">
					<input name="title1" id="title1" type="text" size=30 maxlength=70>
				</td-->
				<!--
				<td class="u1">
					所属栏目：
				...
				<td class="u2" colspan="3">
					<input type="hidden" name="cust_ch_id" value="<%=cust_ch_id%>">
					&nbsp;注：选择所属栏目将把您在此录入的信息显示在您<a href="/member/channelDesc.jsp" target="_blank"><font color="red">企业站对应的栏目</font></a>中！
				</td>
				-->
			</tr>
			<input type="hidden" name="cust_ch_id" value="<%=cust_ch_id%>">
