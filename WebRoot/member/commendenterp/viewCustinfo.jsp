	...
	<%
      ...
      user_id = request.getParameter("user_id");
		...
		ArrayList paramNameList = new ArrayList();
		 ...
		 InfoClassinfo infoClass = new InfoClassinfo();
		 
		 String class_name = infoClass.getProductTypeById(cust_id);
	...
	<body>
			...
			<table width=100% border=0 cellpadding=1 cellspacing=1 align=center bgcolor="#DEEDFD">	
				...
				<tr>
					...
					<td  class="u2" width="85%" colspan="3">
						<div class="ping1">
							<%=paramName%>
						</div>		
					</td>
			...
			<table width=100% border=0 cellpadding=1 cellspacing=1 align=center bgcolor="#DEEDFD">	
				...
				<tr class="u3">
					<td colspan="4" align="center">
						<input class="comeback" type="button" name="sub" value="" onclick="javascript:history.go(-1);">					</td>
				</tr>
			</table>
	</body>
</html>
