				...
				<tr>
					<td>
						...
						<table width=100% border=0 cellpadding=1 cellspacing=1 align=center
							bgcolor="#DEEDFD" id="bo1" style="display:none">
							...
							<tr>
								...
								<td class="u2">
									<div>
										...
										<iframe ID=request
											src=/www/ewebeditor/ewebeditor.htm?id=request&style=coolblue&root_id=
											<%=job_id%> frameborder=0 scrolling=no width=500 HEIGHT=350></iframe>
									</div>
								</td>
							</tr>
