...
<%
	...
	if("1".equals(code)){
		saleList = saleObj.gentSalesByCust_idKey(Integer.valueOf(iStart).intValue(), cust_id,key_word,"0");
		counter = saleObj.getSaleListNumberByKey(cust_id,key_word,"0");
		
	}else if("2".equals(code)){
		
		saleList = saleObj.gentSalesByCust_idDate_T(Integer.valueOf(iStart).intValue(),cust_id, start_time1,end_time1,"0");
		counter = saleObj.getSaleListNumberByDate_T(cust_id, start_time1,end_time1,"0");
	}else{
		saleList = saleObj.gentSalesByMemeberCust_id(Integer.valueOf(iStart).intValue(), cust_id,"0");
		counter = saleObj.gentSalesByMemeberCust_id(cust_id,"0");
	}
	...
	<form action="modifyIndex.jsp" method="post" name="indexdateform">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr class="u1">
				<td colspan=3 align="left" class="head">
					<a href="addSale.jsp">新增供应信息</a>
				</td>
			</tr>
		</table>

		<table  width=100% border=0 cellpadding=1 cellspacing=1 bgcolor="E6F6E9">
			<tr class="u1">
				<td align="left">
		...
		<table width=100% border="0" cellpadding="1" cellspacing="1" align=center bgcolor="#E6F6E9" style="margin-top:13px">
			...
			<tr class="u2">
				...
				<td   align=center>
					<a href=modifySaleInfo.jsp?sale_id=<%=sale_id%> ><img src=/images/edit.gif width=16 height=16 border=0 alt="修改供应信息">
					</a>
				</td>
