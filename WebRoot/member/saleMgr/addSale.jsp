...
<%
	...
	String channel_id=channel.getChIdByContMod("1");
			...
			<table width=100% border="0" cellspacing="1" cellpadding="1" align="center">
				...
				<tr>
					<td>
						...
						<!--02-->
						<table width="100%" border=0 align="center" cellpadding=1 cellspacing=1 bgcolor="#98D9A2" id="bo0">
							<tr>					
								<td class="u1">
									供应标题：
								</td>
			...
			<table width="100%" border=0 align="center" cellpadding=1 cellspacing=1 bgcolor="#98D9A2">
				<tr>
					<td colspan=4 class="u3">
						...
						<input type="hidden" name="sale_type" id="sale_type" value="0">		<!--1:二手 0：供应-->
