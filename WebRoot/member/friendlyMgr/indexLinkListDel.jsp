		...
		<table width="100%" border="0" cellpadding="10" cellspacing="1"
			...
			<tr>
				...
				<td class="grayBL" align="center">
					...
					<html:link action="/doTradeReg.do?trade_type_code=0912" name="em"
						target="right" onclick="return indexLinkListDelconfirmremove()">
                     删除链接
                   </html:link>
				</td>
			</tr>
			<%
				if (list != null && list.size() > 0) {
								int j = 0;
								for (Iterator itera = list.iterator(); itera
										.hasNext();) {
									HashMap downMap = (HashMap) itera.next();
									String name = downMap.get("link_name")
											.toString();
									String index = downMap.get("link_id")
											.toString();
			...
			<tr>
				...
				<td class="grayBL" align="center">
					...
					<html:link action="/doTradeReg.do?trade_type_code=0912"
						name="downMap" target="right"
						onclick="return indexLinkListDelconfirmremove()">
                                         删除链接
                                       </html:link>
				</td>
			</tr>
