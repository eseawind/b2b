	    ...
	    <td>
		     <table width="800" border=0 cellpadding=1 cellspacing=1 align=center bgcolor="#DEEDFD">
		        <tr class="u4" height="25">
			        <td align="center" width="30%">链接名称</td>
					<td align="center" width="20%">链接类型</td>
					<td align="center" width="30%">链接地址</td>
					...
					if(linkArray != null  && linkArray.size()>0)
					{
						...
						for (Iterator inIt = linkArray.iterator(); inIt.hasNext();)
					    {
							...
							<td align="left" ><html:link href="<%=link_url%>"><%=link_url%></html:link></td>
					 		<td align=center><a href=modifyLinkInfo.jsp?link_no=<%=linkIdx%>  TARGET=appwin onClick="mydefss()"><img src=/images/edit.gif width=16 height=16 border=0 alt="修改友情链接"></a></td>
