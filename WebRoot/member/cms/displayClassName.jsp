...
<%
	...
	ArrayList classlist = channel.getChSon (Integer.parseInt(iStart),10,upp_ch_id,cust_id);
	...
	String pageTools = tools.getPageTools(String.valueOf(counter),"10", "modityNewsIndex.jsp?cust_id="+cust_id+"&news_type="+news_types+"&iStart=", Integer.parseInt(iStart));
