...
<%
	...
	String pageTools = tools.getPageTools(String.valueOf(counter),"20", 
											"viewClassNewsInfo.jsp?news_title=" + news_title+ "&cust_id=" + cust_id + "&class_id=" + news_types + "&iStart=", Integer.parseInt(iStart));
%>
<html>
	<head>
			...
			<table width="800" border=0 cellpadding=1 cellspacing=1 align=center bgcolor="#DEEDFD">
				...
				<tr class="u4" height="25">
					...
					<td width="20%" align="center">
						<input type="button" name="reload" value="刷新" onclick="reloadinfo()" />
