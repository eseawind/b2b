...
<%
  ...
  EnquirytrackInfo enquiryObj=new EnquirytrackInfo();
	...
	if("1".equals(code)){
    	...
    	pageTools=tools.getPageTools(String.valueOf(counter),"30","receivStockIndex.jsp?&code="+code+"&key_word="+key_word+"&iStart=",Integer.parseInt(iStart));
    	...
    	pageTools=tools.getPageTools(String.valueOf(counter),"30","receivStockIndex.jsp?&code="+code+"&start_time="+start_time1+"&end_time="+end_time1+"&iStart=",Integer.parseInt(iStart));
	}else{
  		newsList = enquiryObj.getStockListByUser(Integer.valueOf(iStart).intValue(),user_id);
    	counter=enquiryObj.getStockNumberByUser(user_id);
    	pageTools=tools.getPageTools(String.valueOf(counter),"30","receivStockIndex.jsp?&iStart=",Integer.parseInt(iStart));
    }
%>
<html>
<head>
...
<script language="javascript">
	 ...
	 function searchs(){
	 	document.getElementById("keyword2").value = document.getElementById("keyword1").value;
	 	document.indexdateforms.submit();
	 }
</script>
</head>
<body>

	<form action="receivStockIndex.jsp" method="post" name="indexdateform">
		<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
				<td background="/admin/images/content_03.gif" height="43" width="156" align="center"><font size="2"><b>采购留言</b></font></td>
		...
		<table width="800" border=0 cellpadding=2 cellspacing=1 bgcolor="#dddddd" >		
			<tr bgcolor="white" >
				<td align="left">
				关键字:<input type="text" id="keyword1" name="key_words" value="">
					
					<img src="/admin/images/chaxun.gif" onclick="searchs();" style="cursor:hand;">	
				</td>
			</tr>
		</table>
	  ...
	  <tr>
	    <td>
		     <table width=800 border=0 cellpadding=2 cellspacing=1 align=center  bgcolor="#e7e7e7">
		        <tr>
			        <td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;"  align=center width="25%">采购主题</td>
		            ...
		            {   int i=0;
		              	 for (Iterator it = newsList.iterator(); it.hasNext();)
		                  {
						        ...
						        <tr  style="background-color:#f9f9f9; " id="changcolor_tr<%=i%>" onmouseover="MM_changeProp('changcolor_tr<%=i%>','','backgroundColor','#ffffff','DIV')" onmouseout="MM_changeProp('changcolor_tr<%=i%>','','backgroundColor','#f9f9f9','DIV')">
					              ...
					              <td  style=" color:#000000;"  align=center><a href=trackLevelInfo.jsp?trade_id=<%=trade_id%> target=blank><img src=/images/edit.gif width=16 height=16 border=0></a></td>
					            </tr>
	...
	<form action="receivStockIndex.jsp" method="post" name="indexdateforms">
		<input type="hidden" name="code" value="1">
		<input type="hidden" id="keyword2" name="key_word" value="">
	</form>
</body>
</html>
