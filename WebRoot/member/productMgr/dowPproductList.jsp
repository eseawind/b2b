	  ...
	  <tr>
	    <td>
		     <table width="100%" border=0 cellpadding=2 cellspacing=1 align=center bgcolor="#e7e7e7">
		        <tr>
					<td  class="line1" style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="16%">商品名称</td>
					<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="24%">商品描述</td>
					<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="10%">商品类别</td>
					<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="15%">销售价格</td>
					<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="15%">商品发布日期</td>
					<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="15%">商品销售地</td>
					<td style="background-color:#e2e2e2; color:#000000;  font-weight:bold; font-size:13px;" align=center width="5%">注销</td>
		        </tr>
		        <%
		            if(commList != null && commList.size()>0 )
		            {
		              	 for (Iterator it = commList.iterator(); it.hasNext();)
		                  {
						        ...
						        <tr style="background-color:#f9f9f9; " id="changcolor_tr<%=commodity_id%>" onmouseover="MM_changeProp('changcolor_tr<%=commodity_id%>','','backgroundColor','#ffffff','DIV')" onmouseout="MM_changeProp('changcolor_tr<%=commodity_id%>','','backgroundColor','#f9f9f9','DIV')">
					              ...
					              <td  style=" color:#000000;"  align=center><a href=/doTradeReg.do?commodity_id=<%=commodity_id%>&trade_type_code=0276 target="_self"  onClick="return dowPproductListchechIfo()"><img src=/img/del.gif width=16 height=16 border=0></a></td>
					            </tr>
					     ...
					     <tr>
							<td  align="left" colspan="3"  class="ping1" style="font-weight:normal;">共<%=counter%>条 &nbsp;共<%=pages%>页</td>
							<td  align="right" class="ping1" colspan="4"><a href="downProductIndex.jsp?iStart=0&meun_id=<%=meun_idx%>">首页 </a>&nbsp; &nbsp;<a href="downProductIndex.jsp?iStart=<%=pageUp%>&meun_id=<%=meun_idx%>">上一页</a> &nbsp;<a href="downProductIndex.jsp?iStart=<%=pageDown%>&meun_id=<%=meun_idx%>">下一页 </a>&nbsp; <a  href="downProductIndex.jsp?iStart=<%=pages%>&meun_id=<%=meun_idx%>">尾页</a></td>
				         </tr>
