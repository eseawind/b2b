...
<%
	String class_id = "",repository_id ="",channel_id="";
	if (request.getParameter("class_id") != null) {
		class_id = request.getParameter("class_id").toString();
	}
	if (request.getParameter("repository_id") != null) {
		repository_id = request.getParameter("repository_id").toString();
	}
		...
		<table width="100%" border=0 align="center" cellpadding=1 cellspacing=1 bgcolor="#DEEDFD" id="bo0">				
			...
			<tr style="display:none">
				...
				<td width="280" class="u2">
					...
					跳转网址-->
					<input type="hidden" name="contents" id="contents" value="00">
				</td>
				<td class="u1" style="display:none">
					相关信息：
				</td>
			...
			<tr>
				...
				<td class="u2" colspan="3">
					...
					<div style="padding-left: 0px;padding-bottom: 0px;padding-right: 0px;padding-top: 0px;">
						<iframe src="/inc/uploadImg.jsp?root_id=<%=repository_id%>" width="100%" height="180px" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
					</div>
				</td>
			...
			<tr style="display:none">
				...
				<td class="u2">
					<input name="article_temp" id="article_temp" type="text" size="20">
			...
			<tr style="display:none">
				...
				<td class="u2" colspan="3">
					<textarea name="info_dsec" id="info_dsec" rows="6" cols="35"></textarea>
				</td>
				<td class="u1"style="display:none">
					关键字：
				</td>
