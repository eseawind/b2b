...
<%
	...
	String save_dir = "";
	if( info.getUpFilePath(up_ch_id) != "" || !info.getUpFilePath(up_ch_id).equals("") )	
	{
	...
	//out.print( "up_ch_level="+up_ch_level );
	String ch_id = bean.GenNumTradeId();
	String right_tag = comm.getSelectItems("117");
	String cont_mod = comm.getSelectItems("119");
			...
			<div id="sale-list" style="display:block" align="center">
				<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" bgcolor="#dddddd">
					...
					<tr>
						...
						<td bgcolor="#FFFFFF">
							<div class="ping1">
								<textarea id="ch_key" name="ch_key" rows="6" cols="30"></textarea>
							</div>
						</td>
						<td bgcolor="#ffffff">
							<div style="text-align:right; font-weight:bold;">
						...
						<td bgcolor="#FFFFFF">
							<div class="ping1">
								<textarea id="ch_desc" name="ch_desc" rows="6" cols="30"></textarea>
							</div>
						</td>
					</tr>
					<tr>
					<td bgcolor="#FFFFFF" align="center" height="50" colspan="4">
						<input name="trade_type_code" type="hidden" id="trade_type_code" value="0011">
