					...
					<tr>
						...
						<td class="u2">
							...
							<tr class="u4" height="25">
								<td width="20%" align="center" >选择分类</td>
					      ...
					      <td width="20%" align="center" style="background-color: #ffffff; color: #000000;  font-size: 12px;">
								...
								<td width="20%" align="center" style="background-color: #ffffff; color: #000000;  font-size: 12px;">
									<%if(list!=null){%>
									<a href="/member/addProductInfoMgr/delproduct.jsp?up_class_id=<%=class_id_up%>" title="查看下级分类"><%=class_name%></a>
									<%}else{%>
									<%=class_name%>
									<%}%>
