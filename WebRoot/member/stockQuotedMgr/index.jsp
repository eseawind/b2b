...
<%
	...
	if("1".equals(code))
	{
		linkArray = enqBean.getEnquriyInfoByKey(Integer.parseInt(iStart), user_id, "0", "0",key_word);
		counter = enqBean.getEnquriyInfoNumberByKey(user_id, "0", "0",key_word);
	}
	else if("2".equals(code))
	{
		linkArray = enqBean.getEnquriyInfoByDate(Integer.parseInt(iStart), user_id, "0", "0",start_time1,end_time1);
		counter = enqBean.getEnquriyInfoNumberByDate(user_id, "0", "0",start_time1,end_time1);
	}
	else
	{
		linkArray = enqBean.getEnquriyInfoByTag(Integer.parseInt(iStart), user_id, "0", "0");
		counter = enqBean.getEnquriyInfoByTag(user_id, "0", "0");
	}
		if(null!=linkArray){
	String userid="";
