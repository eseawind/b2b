						...
						<div id="manager_body">
							<div id="manager_body_right">
								<table width=100% border=0 cellpadding=5 cellspacing=1 align=center bgcolor="#dddddd">
									<tr>
										<td class="l_td" align="center" width="20%">
											会员名称
										</td>
										<td class="l_td" align="center" width="30%">
											客户名称
										</td>
											<td class="l_td" align="center" width="10%">
											客户级别
										</td>
										<td class="l_td" align="center" width="20%">
											黄金数量
									...
									<%
									  ...
									  %>
										<td align="left" width="20%" class="t1" >
											<%=user_name%>
										</td>
										<td align="left" width="30%" class="t2">
											<%=cust_name%>
										</td>
										<td align="left" width="10%" class="t2">
											<%=cust_type%>
										</td>
										<td align="center" width="20%"class="t2">
											<%=property_value%>两黄金
										</td>
										<td align="center" width="20%" class="t2">
