      ...
      <form name="newform" action=/doTradeReg.do method="post" target="_self">
        <tr>
          ...
          <td class="u2" colspan="3"><div>
              <input name="account_name" id="account_name" type="text" size="30" value="<%=account_name%>">
          </div></td>
        </tr>
        <tr>
          <td class="u1" > 账号： </td>
          <td class="u2"><input name="bank_code" id="bank_code" type="text" size="30" maxlength="100" onKeyUp="if(isNaN(value))execCommand('undo')" value="<%=bank_code%>">
          </td>
          <td class="u1" > 密码： </td>
          <td class="u2"><div>
              <input name="bank_id" id="bank_id" type="text" size="30" maxlength="100" value="<%=bank_id%>">
          </div></td>
        </tr>
        <tr>
          <td colspan="4" class="u2"><center>
          		<%if(tt==0){%>
              ...
              <input type="hidden" id="trade_type_code" name="trade_type_code" value="0127">
              <input class="tjan" name="bnt" type="submit" value="" onClick="return clickSel()">
          </center> </td>
        </tr>
