...
<%
	...
	String user_name = "", login_cust_id = "", subsys_codenow = "B2B",web="",cust_id="",cust_type="";
	...
	cust_id = top_session.getAttribute("SESSION_CUST_ID").toString();
	}
	if (top_session.getAttribute("SESSION_CUST_TYPE") != null) {
	cust_type = top_session.getAttribute("SESSION_CUST_TYPE").toString();
	}
	...
	//out.println(cust_id+" class_name="+class_name);
...
<html>
	...
	<body>
		<TABLE width="100%" border="0" align="center" cellPadding="0" cellSpacing="0" class="topnav">
			<TBODY>
				<TR>
					<TD align="left" width="297"><a href="<%=logolink%>"  target="_blank"> <div style=" width:400px; height:68px; background:none;
filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='<%=logourl%>' ,sizingMethod='crop'); margin:5px 0 0 10px;"></div></a></TD>
	  				<TD valign="bottom">
						<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<tr>
									<TD height="30" style="color:#ffffff; font-size:9px;margin-right:10px" align="right">
										<img src="/member/images/tophome.gif" align="absmiddle" border="0" />&nbsp;&nbsp;
										<a href="/" target="_blank"><font style="font-size:13px">首页</font></a>|
										<%
											if( list.size() > 0 )
											{
										...
										%>
												<a href="<%=save_dir%>" target="_blank"><font style="font-size:13px"><%=ch_name%></font></a>|
										<%
												}
											}
										%>
		...
		<TABLE class="topmenu" height="30" cellSpacing="0" cellPadding="0" width="100%" border="0">
			<TBODY>
				<TR>
					<TD width="79%" align="left">
						&nbsp;&nbsp;&nbsp;
						<img src="images/member_ico.gif" width="14" height="15" align="absmiddle">
						<font color="#ffffff">欢迎&nbsp;<%=class_name%>&nbsp;
						<%=cust_name%>
						登录我的商务室 </font>  
						<A target="_parent" href="/member/out.jsp"><font color="#ffffff">[退出]</font> </A>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<A target="_blank" href="/member/help/"><font color="#ffffff">[帮助]</font> </A>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						
					</TD>
					<TD width="21%">
						<img src="images/ppc.gif" align="absmiddle">
						<font color="#ffffff">咨询热线：0551-5310317</font>
					</TD>
				</TR>
			</TBODY>
		</TABLE>
