				...
				<td>
					...
					<td class="u2" width="85%">
						<div class="ping1">
							...
							<input type="button" onClick="open('/member/channelMgr/filelist.jsp?id=index_temp','file','height=400,width=400,toolbar=0,status=0,scroll=yes')" value="浏览"/>	
						</div>
					</td>
					</tr>
					...
					<tr>
						<td class="u3" colspan="2">
							...
							<input name="submit" type="submit" value="更新主页html" onclick="return check_Value()">
						</td>
					</tr>
				</table>
				<table width=100% border=0 cellpadding=1 cellspacing=1 align=center bgcolor="#98D9A2">
					<tr>
						<td>
							<div id="proDiv" style="display: none;"><img src="/images/wait.gif" border="0"><font size="3">正在生成首页............</font></div>
